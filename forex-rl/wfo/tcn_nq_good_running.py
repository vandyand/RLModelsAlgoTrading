...
Run from forex-rl root:
    ...
    python3 -m wfo.tcn_nq_good_running
"""
...
def _run_windows(base_cfg_path: str) -> None:
    ...
    # Respect an optional windows_limit in the good-running config.
...
def main() -> None:
    # Use the frozen good-running NQ config by default.
    cfg_path = "wfo/tcn_nq_good_running_3w1w.json"
